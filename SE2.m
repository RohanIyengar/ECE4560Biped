...
methods
  ...
  g3.M = productG;    % Set the return element matrix to product.
  ...
  if ( (size(x,1) == 2) && (size(x,2) == 1) )
    ...
    rotationMatrix = g.getRotationMatrix();
    translationVector = g.getTranslation();
    x2 = rotationMatrix * x + translationVector;
